...
const Video = (props?:any) => {
  ...
  return (
    <>
        ...
        return (
          <div className='md:w-[300px] h-auto m-[30px] lg:w-[308px] p-1 rounded bg-white shadow-2xl pb-[10px] hover:scale-105 duration-100 ease-in-out'><iframe src={link} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowfullscreen>{link}</iframe><div className='px-[10px]'>
